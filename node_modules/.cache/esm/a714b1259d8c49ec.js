let mysql,dbconfig;_9d8‍.x([["getSell",()=>getSell],["getSellShowPage",()=>getSellShowPage],["postSell",()=>postSell],["getNew",()=>getNew],["getPutSell",()=>getPutSell],["putSell",()=>putSell],["deleteItem",()=>deleteItem]]);_9d8‍.w("mysql",[["default",["mysql"],function(v){mysql=v}]]);_9d8‍.w("../config/database",[["default",["dbconfig"],function(v){dbconfig=v}]]);
...
var connection = mysql.createConnection(dbconfig.connection);
    ...
    connection.query(findItems, (err, items) => {
        if (err) throw err;
        _9d8‍.g.console.log(items)
        res.render('sell/index', { items });
    });
}

       const getSellShowPage = async (req, res, next) => {
    let getSell = `SELECT *
    FROM
    users AS u
    INNER JOIN sell_items AS s
    ...
    res.render('sell/new');
       ...
       const getPutSell = async (req, res, next) => {
    let findSell = `SELECT * 
    FROM users AS u 
    ...
    connection.query(findSell, (err, result) => {
       ...
       const putSell = async (req, res, next) => {
    let findSell = `SELECT * 
    FROM users AS u 
    INNER JOIN sell_items AS l
    ON l.users_id = u.users_id
