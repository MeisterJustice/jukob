let mysql,dbconfig;_a95‍.x([["getRent",()=>getRent],["getRentShowPage",()=>getRentShowPage],["postRent",()=>postRent],["getNew",()=>getNew],["deleteItem",()=>deleteItem]]);_a95‍.w("mysql",[["default",["mysql"],function(v){mysql=v}]]);_a95‍.w("../config/database",[["default",["dbconfig"],function(v){dbconfig=v}]]);
...
var connection = mysql.createConnection(dbconfig.connection);
    ...
    connection.query(findItems, (err, items) => {
        if (err) throw err;
        _a95‍.g.console.log(items)
        res.render('rent/index', { items });
    });
}

       const getRentShowPage = async (req, res, next) => {
    let getRent = `SELECT *
    FROM
    users AS u
    INNER JOIN rent_items AS s
