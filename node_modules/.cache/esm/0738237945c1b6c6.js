let mysql,dbconfig,util,User;_45c‍.x([["getIndex",()=>getIndex],["searchUser",()=>searchUser],["getCustom",()=>getCustom],["getsignup",()=>getsignup],["postsignup",()=>postsignup],["getLogin",()=>getLogin],["postLogin",()=>postLogin],["getLogout",()=>getLogout],["getProfile",()=>getProfile],["getProfileSettings",()=>getProfileSettings],["getProfileShow",()=>getProfileShow],["putProfile",()=>putProfile],["deleteUser",()=>deleteUser]]);_45c‍.w("mysql",[["default",["mysql"],function(v){mysql=v}]]);_45c‍.w("../config/database",[["default",["dbconfig"],function(v){dbconfig=v}]]);_45c‍.w("util",[["default",["util"],function(v){util=v}]]);_45c‍.w("../models",[["default",["User"],function(v){User=v}]]);
...
var connection = mysql.createConnection(dbconfig.connection);
  ...
  let user = `SELECT * FROM users WHERE username LIKE '%${req.body.name}%'`;
  connection.query(user, (err, users) => {
    if(err) throw err;
    _45c‍.g.console.log(users);
  });
  connection.end();
}
