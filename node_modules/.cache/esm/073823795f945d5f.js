let mysql,dbconfig,util,User,moment;_5f9‍.x([["getIndex",()=>getIndex],["searchUser",()=>searchUser],["getCustom",()=>getCustom],["getsignup",()=>getsignup],["postsignup",()=>postsignup],["getLogin",()=>getLogin],["postLogin",()=>postLogin],["getLogout",()=>getLogout],["getProfile",()=>getProfile],["getProfileSettings",()=>getProfileSettings],["getProfileShow",()=>getProfileShow],["putProfile",()=>putProfile],["deleteUser",()=>deleteUser]]);_5f9‍.w("mysql",[["default",["mysql"],function(v){mysql=v}]]);_5f9‍.w("../config/database",[["default",["dbconfig"],function(v){dbconfig=v}]]);_5f9‍.w("util",[["default",["util"],function(v){util=v}]]);_5f9‍.w("../models",[["default",["User"],function(v){User=v}]]);_5f9‍.w("moment",[["default",["moment"],function(v){moment=v}]]);
...
var connection = mysql.createConnection(dbconfig.connection);
  ...
  connection.query(findItems, (err, result) => {
    ...
    connection.query(findLodges, (err, result1) => {
      if(err) throw err;
      let registerDate = moment(result[0].register_date).format("Do MMMM, YYYY");
