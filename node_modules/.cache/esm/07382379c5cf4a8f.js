let mysql,dbconfig,util,User;_c5c‍.x([["getIndex",()=>getIndex],["getCustom",()=>getCustom],["getsignup",()=>getsignup],["postsignup",()=>postsignup],["getLogin",()=>getLogin],["postLogin",()=>postLogin],["getLogout",()=>getLogout],["getProfile",()=>getProfile],["getProfileSettings",()=>getProfileSettings],["getProfileShow",()=>getProfileShow],["putProfile",()=>putProfile],["deleteUser",()=>deleteUser]]);_c5c‍.w("mysql",[["default",["mysql"],function(v){mysql=v}]]);_c5c‍.w("../config/database",[["default",["dbconfig"],function(v){dbconfig=v}]]);_c5c‍.w("util",[["default",["util"],function(v){util=v}]]);_c5c‍.w("../models",[["default",["User"],function(v){User=v}]]);
...
var connection = mysql.createConnection(dbconfig.connection);
  ...
  _c5c‍.g.console.log(req.body.search);
  _c5c‍.g.console.log(req.body.itemName);
  _c5c‍.g.console.log(req.body.school);
  _c5c‍.g.console.log(req.body.priceRange);
  _c5c‍.g.console.log(req.body.location);
  ...
  connection.query(findUserInfo, (err, result) => {
    ...
    connection.query(findDepartments, (err, department) => {
      ...
      connection.query(findSkills, (err, skill) => {
       ...
       const getProfileShow = async (req, res, next) => {
  let userSell = `SELECT *
  FROM
  users AS u
  INNER JOIN sell_items AS s
