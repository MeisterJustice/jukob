let mysql,dbconfig;_15c‍.x([["getLodge",()=>getLodge],["getLodgeShowPage",()=>getLodgeShowPage],["postLodge",()=>postLodge],["getNewLodge",()=>getNewLodge],["getPutLodge",()=>getPutLodge],["putLodge",()=>putLodge],["deleteItem",()=>deleteItem]]);_15c‍.w("mysql",[["default",["mysql"],function(v){mysql=v}]]);_15c‍.w("../config/database",[["default",["dbconfig"],function(v){dbconfig=v}]]);

var connection = mysql.createConnection(dbconfig.connection);


       const getLodge = async (req, res, next) => {
    ...
    connection.query(findLodges, (err, items) => {
        if (err) throw err;
        _15c‍.g.console.log(items)
        res.render('lodge/index', { items });
    });
}

       const getLodgeShowPage = async (req, res, next) => {
    let getSell = `SELECT *
    FROM
    users AS u
    INNER JOIN lodges AS s
    ...
    connection.query(findUser, (err, user) => {
       ...
       const getNewLodge = async (req, res, next) => {
    res.render('lodge/new');
}

       const getPutLodge = async (req, res, next) => {
    ...
    connection.query(findLodge, (err, result) => {
       ...
       const putLodge = async (req, res, next) => {
    let findLodge = `SELECT * 
    FROM users AS u 
    INNER JOIN lodges AS l
    ON l.users_id = u.users_id
    ...
    connection.query(findLodge, (err, result) => {
        ...
        _15c‍.g.console.log(req.body.name)
